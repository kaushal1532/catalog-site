...
<div class="card mb-3 rounded-0">
	...
	<div class="card-body">
		<form action="<?php bloginfo('url'); ?>" method="get" class="input-group ">
			<input type="text" name="s" class="form-control" placeholder="<?php _e( 'Enter Text', 'kit_theme' ); ?>" aria-describedby="button-addon2" value="<?php echo get_search_query(); ?>">
